...
The apply_diff() function is the core pure-text transform shared by both
the function engine and native engine. It has zero I/O — it takes strings
in and returns strings out.

3-tier fuzzy matching: exact -> rstrip -> strip
"""
